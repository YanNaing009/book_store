...
<body class="bg-light">
    ...
    <section id="card-Holder" class="mt-5 mb-5">
      <div class="container-lg align-items-center">
         ...
         <c:forEach var="book" items="${books }" end="11">
		 ...
		 <c:url var="orderLink" value="book">
          ...
          <div class="card col-12 col-sm-8 col-md-4 col-lg-3 mb-2 me-2" style="border-radius: 15px; border-color: #878787;">
            <img src="${book.image }" class="card-img-top mt-1" alt="book">
    ...
    <div>
	    <nav aria-label="Page navigation example">
		  <ul class="pagination justify-content-center">
		    ...
		    <li class="page-item active"><a class="page-link" href="book">1</a></li>
		    <li class="page-item"><a class="page-link" href="book?mode=SHOW2">2</a></li>
		    <li class="page-item"><a class="page-link" href="book?mode=SHOW3">3</a></li>
		    <li class="page-item">
		      <a class="page-link" href="book?mode=SHOW2" aria-label="Next">
