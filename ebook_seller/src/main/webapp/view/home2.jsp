...
<body class="bg-light">
    ...
    <section id="card-Holder" class="mt-5 mb-5">
      <div class="container-lg align-items-center justify-content-center">
         ...
         <c:forEach var="book" items="${books }" begin="12" end="23" >
    ...
    <div>
	    <nav aria-label="Page navigation example">
		  <ul class="pagination justify-content-center">
		     <li class="page-item">
		      <a class="page-link" href="book" aria-label="Previous">
		        <span aria-hidden="true">&laquo;</span>
		      </a>
    		</li>
		    <li class="page-item"><a class="page-link" href="book">1</a></li>
		    <li class="page-item active"><a class="page-link" href="book?mode=SHOW2">2</a></li>
		    <li class="page-item"><a class="page-link" href="book?mode=SHOW3">3</a></li>
		    <li class="page-item">
		      <a class="page-link" href="book?mode=SHOW3" aria-label="Next">
